...
namespace WebShop.Controllers
{
    public class OrderItemsController : Controller
    {
        ...
        {
            ViewBag.OrderID = new SelectList(db.Orders, "OrderID", "OrderRef");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "OrderItemID,OrderItemProductNumber,OrderItemName,OrderItemDescription,OrderItemPrice,OrderItemImagePath,OrderCount,OrderID")] OrderItem orderItem)
        {
